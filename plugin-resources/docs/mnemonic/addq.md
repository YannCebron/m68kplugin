...
## Application
`ADDQ` is used to add a small constant to the operand at the effective address. Some assemblers permit you to write [`ADD`](add.md) and then choose `ADDQ` *automatically* if the constant is in the range 1 to 8.
