...
public class M68kRegisterSymbolDocumentationTest extends BasePlatformTestCase {
  ...
  public void testDataRegister() {
    doTest(" move.l d<caret>0,d1", "D0", "<style>table { white-space: nowrap; } blockquote { padding-left: 10px; padding-right: 10px; padding-bottom: 5px; }</style><div class='definition'><pre><h1><code>D0</code></h1></pre></div><table class='sections'><tr><td valign='top' class='section'><p>CPU:</td><td valign='top'>MC68000 Family</td></table><div class='content'><h1>Data Registers (<code>D0</code>-<code>D7</code>)</h1>\n" +
  ...
  public void testSfcRegister() {
    doTest(" movec S<caret>FC,d0", "SFC", "<style>table { white-space: nowrap; } blockquote { padding-left: 10px; padding-right: 10px; padding-bottom: 5px; }</style><div class='definition'><pre><h1><code>SFC</code></h1></pre></div><table class='sections'><tr><td valign='top' class='section'><p>CPU:</td><td valign='top'>MC68010+</td></table><div class='content'><h1>Alternate Function Code Registers (<code>SFC</code> and <code>DFC</code>)</h1>\n" +
