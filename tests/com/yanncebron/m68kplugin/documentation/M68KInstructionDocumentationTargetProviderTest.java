...
public class M68KInstructionDocumentationTargetProviderTest extends BasePlatformTestCase {
  ...
  public void testRteInstructionControlFlowTrapReturn() {
    doTest(" rt<caret>e", "<style>table { white-space: nowrap; } blockquote { padding-left: 10px; padding-right: 10px; padding-bottom: 5px; }</style><div class='definition'><pre><h1><code>RTE</code></h1>Return from exception</pre></div><table class='sections'><tr><td valign='top' class='section'><p>CPU:</td><td valign='top'>MC68000 Family</td></table><table class='sections'><tr><td valign='top' class='section'><p>Privileged:</td><td valign='top'>MC68000 Family</td></table><table class='sections'><tr><td valign='top' class='section'><p>Control Flow:</td><td valign='top'>TRAP_RETURN</td></table><br><h4><code>RTE&lt;unsized&gt;</code></h4>");
  }
