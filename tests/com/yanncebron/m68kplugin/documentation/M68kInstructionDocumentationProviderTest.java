...
public class M68kInstructionDocumentationProviderTest extends BasePlatformTestCase {
  ...
  public void testMovecInstructionDoc() {
    doTest(" move<caret>c", (psiElement, documentationProvider) -> {
      String doc = documentationProvider.generateDoc(psiElement, getOriginalElement());
      assertEquals("<style>table { white-space: nowrap; } blockquote { padding-left: 10px; padding-right: 10px; padding-bottom: 5px; }</style><div class='definition'><pre><h1><code>MOVEC</code></h1>Move Control Register</pre></div><table class='sections'><tr><td valign='top' class='section'><p>CPU:</td><td valign='top'>MC68010+</td></table><br><h4><code>MOVEC&#8228;l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CTRL,&lt;DATA_OR_ADDRESS_REGISTER></code></h4><table class='sections'><tr><td valign='top' class='section'><p>Privileged:</td><td valign='top'>MC68000 Family</td></table><table style=\"width: 100%;\"><tr><th></th><th style=\"text-align:center;\">Dn</th><th style=\"text-align:center;\">An</th></tr><tr><td class=\"section\" valign=\"top\" width=\"15%\"/>Destination:</td><td style=\"text-align:center;\">✓</td><td style=\"text-align:center;\">✓</td></tr></table><br><h4><code>MOVEC&#8228;l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;DATA_OR_ADDRESS_REGISTER>,CTRL</code></h4><table class='sections'><tr><td valign='top' class='section'><p>Privileged:</td><td valign='top'>MC68000 Family</td></table><table style=\"width: 100%;\"><tr><th></th><th style=\"text-align:center;\">Dn</th><th style=\"text-align:center;\">An</th></tr><tr><td class=\"section\" valign=\"top\" width=\"15%\"/>Source:</td><td style=\"text-align:center;\">✓</td><td style=\"text-align:center;\">✓</td></tr></table><br>", doc);
    });
  }
