...
import com.yanncebron.m68kplugin.lang.psi.M68kBsetInstruction;
import com.yanncebron.m68kplugin.lang.psi.M68kDataSize;

public class BsetInstructionPsiTest extends M68kPsiTestCase {
  ...
  private M68kBsetInstruction parse(String text) {
    return assertInstanceOf(doParse(" " + text), M68kBsetInstruction.class);
  }
