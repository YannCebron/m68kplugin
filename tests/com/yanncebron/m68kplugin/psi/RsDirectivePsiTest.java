...
import com.yanncebron.m68kplugin.lang.psi.M68kRsDirective;

public class RsDirectivePsiTest extends M68kPsiTestCase {

  public void testWithoutDataSize() {
    final M68kRsDirective directive = parse("rs 42");
  ...
  public void testWithDataSize() {
    final M68kRsDirective directive = parse("rs.b 42");
  ...
  private M68kRsDirective parse(String text) {
    return assertInstanceOf(doParse(" " + text), M68kRsDirective.class);
  }
}
