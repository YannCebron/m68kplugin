...
public class EqurDirectivePsiTest extends M68kPsiTestCase<M68kEqurDirective> {

  public EqurDirectivePsiTest() {
    super(M68kEqurDirective.class);
  }

  public void testDataRegister() {
    final M68kEqurDirective directive = parse("label equr d0", true);
