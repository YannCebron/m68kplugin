...
public enum M68kAmigaHardwareRegister {
  ...
  DSKDAT("DSKDAT", "DFF026", "Disk DMA data write", "DSKDATR", Chipset.OCS, true, Access.WRITE, EnumSet.of(Chip.PAULA)),
  ...
  BLTCPTH("BLTCPTH", "DFF048", "Blitter pointer to source C (high 5 bits)", "BLTxPTL", Chipset.OCS, true, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BLTBPTH("BLTBPTH", "DFF04C", "Blitter pointer to source B (high 5 bits)", "BLTxPTL", Chipset.OCS, true, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  AUD0LCH("AUD0LCH", "DFF0A0", "Audio channel 0 location (high 5 bits)", "AUDxLCL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  AUD1LCH("AUD1LCH", "DFF0B0", "Audio channel 1 location (high 5 bits)", "AUDxLCL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  AUD2LCH("AUD2LCH", "DFF0C0", "Audio channel 2 location (high 5 bits)", "AUDxLCL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  AUD3LCH("AUD3LCH", "DFF0D0", "Audio channel 3 location (high 5 bits)", "AUDxLCL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BPL1PTH("BPL1PTH", "DFF0E0", "Bit plane pointer 1 (high 5 bits)", "BPLxPTL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BPL2PTH("BPL2PTH", "DFF0E4", "Bit plane pointer 2 (high 5 bits)", "BPLxPTL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BPL3PTH("BPL3PTH", "DFF0E8", "Bit plane pointer 3 (high 5 bits)", "BPLxPTL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BPL4PTH("BPL4PTH", "DFF0EC", "Bit plane pointer 4 (high 5 bits)", "BPLxPTL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BPL5PTH("BPL5PTH", "DFF0F0", "Bit plane pointer 5 (high 5 bits)", "BPLxPTL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BPL6PTH("BPL6PTH", "DFF0F4", "Bit plane pointer 6 (high 5 bits)", "BPLxPTL", Chipset.OCS, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BPL7PTH("BPL7PTH", "DFF0F8", "Bit plane pointer 7 (high 5 bits)", "BPLxPTL", Chipset.AGA, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
  ...
  BPL8PTH("BPL8PTH", "DFF0FC", "Bit plane pointer 8 (high 5 bits)", "BPLxPTL", Chipset.AGA, false, Access.WRITE, EnumSet.of(Chip.AGNUS_ALICE)),
