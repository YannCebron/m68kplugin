...
public class M68KAmigaHardwareRegisterDocsCreatorTest extends UsefulTestCase {
  ...
  public void testCIAA_CRA() {
    assertEquals("<style>table { white-space: nowrap; } blockquote { padding-left: 10px; padding-right: 10px; padding-bottom: 5px; }</style><div class='definition'><pre><b>CIAACRA</b><br/>CIAA Control Register A</pre></div><table class='sections'><tr><td valign='top' class='section'><p>Address:</td><td valign='top'><code>$BFEE01</code><a href='m68kCopyData://$BFEE01'><icon src='AllIcons.Actions.Copy'/></a></td><tr><td valign='top' class='section'><p>CIA:</td><td valign='top'>CIAA</td><tr><td valign='top' class='section'><p>Access:</td><td valign='top'>Read/Write</td><tr><td valign='top' class='section'><p>Related:</td><td valign='top'><table><tr><td valign='top'><b><a href='m68kBrowser://CIAACRA'>CIAACRA</a></b></td><td valign='top'><a href='m68kBrowser://CIABCRA'>CIABCRA</a></td></tr></table></td></table><div class='content'><p>Control Register A</p>\n" +
  ...
  private static @NotNull String getRegisterDoc(M68kAmigaHardwareRegister register) {
    return new M68kAmigaHardwareRegisterDocsCreator(register, List.of(M68kAmigaHardwareRegister.values())).generateDoc(true, true);
  }
}
