...
public class M68KAmigaHardwareRegisterDocsCreatorTest extends UsefulTestCase {
  ...
  public void testBPLHDAT() {
    assertEquals("<style>table { white-space: nowrap; } blockquote { padding-left: 10px; padding-right: 10px; padding-bottom: 5px; }</style><div class='definition'><pre><b>BPLHDAT</b><br/>Ext logic UHRES bit plane identifier</pre></div><table class='sections'><tr><td valign='top' class='section'><p>Address:</td><td valign='top'><code>$DFF07A</code><a href='m68kBrowserCopy://$DFF07A'><icon src='AllIcons.Actions.Copy'/></a>&nbsp;&ndash;&nbsp;<code>$007A</code><a href='m68kBrowserCopy://$007A'><icon src='AllIcons.Actions.Copy'/></a></td><tr><td valign='top' class='section'><p>Chip Set (Chips):</td><td valign='top'>ECS (Agnus/Alice)</td><tr><td valign='top' class='section'><p>Access:</td><td valign='top'>Write</td><tr><td valign='top' class='section'><p>Copper Danger:</td><td valign='top'>✓</td></table><div class='content'><p>This is the number (sign extended) that is added to the UHRES bitplane\n" +
