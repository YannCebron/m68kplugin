...
public interface M68kTypes {
  ...
  IElementType ADM_DOUBLE_DRD = new M68kCompositeElementType("ADM_DOUBLE_DRD");
  ...
  IElementType BGND_INSTRUCTION = new M68kCompositeElementType("BGND_INSTRUCTION");
  ...
  IElementType LPSTOP_INSTRUCTION = new M68kCompositeElementType("LPSTOP_INSTRUCTION");
  ...
  IElementType OPT_DIRECTIVE_ARG = new M68kCompositeElementType("OPT_DIRECTIVE_ARG");
  ...
  IElementType TBLUN_INSTRUCTION = new M68kCompositeElementType("TBLUN_INSTRUCTION");
  IElementType TBLU_INSTRUCTION = new M68kCompositeElementType("TBLU_INSTRUCTION");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == ADM_DOUBLE_DRD) {
        return new M68kAdmDoubleDrdImpl(node);
      }
      ...
      else if (type == ASSERT_DIRECTIVE) {
        return new M68kAssertDirectiveImpl(node);
      }
      ...
      else if (type == BGND_INSTRUCTION) {
        return new M68kBgndInstructionImpl(node);
      }
      ...
      else if (type == LPSTOP_INSTRUCTION) {
        return new M68kLpstopInstructionImpl(node);
      }
      ...
      else if (type == OPT_DIRECTIVE_ARG) {
        return new M68kOptDirectiveArgImpl(node);
      }
      ...
      else if (type == TBLUN_INSTRUCTION) {
        return new M68kTblunInstructionImpl(node);
      }
      else if (type == TBLU_INSTRUCTION) {
        return new M68kTbluInstructionImpl(node);
      }
