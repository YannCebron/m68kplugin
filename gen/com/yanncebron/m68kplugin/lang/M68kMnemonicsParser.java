...
public class M68kMnemonicsParser {
  ...
  static boolean add_sub_tail_all_ard(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "add_sub_tail_all_ard")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = add_sub_tail_all_ard_0(b, l + 1);
  ...
  // data_size_word_long?
  private static boolean add_sub_tail_all_ard_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "add_sub_tail_all_ard_0")) return false;
    data_size_word_long(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_word_long? adm_ard COMMA adm_drd
  static boolean add_sub_tail_ard_drd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "add_sub_tail_ard_drd")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = add_sub_tail_ard_drd_0(b, l + 1);
    r = r && adm_ard(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_drd(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_word_long?
  private static boolean add_sub_tail_ard_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "add_sub_tail_ard_drd_0")) return false;
    data_size_word_long(b, l + 1);
    return true;
  }
  ...
  static boolean add_sub_tail_data_drd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "add_sub_tail_data_drd")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = add_sub_tail_data_drd_0(b, l + 1);
  ...
  // data_size_all?
  private static boolean add_sub_tail_data_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "add_sub_tail_data_drd_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_all?       adm_drd COMMA operand_alterable_memory
  static boolean add_sub_tail_drd_alterable_memory(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "add_sub_tail_drd_alterable_memory")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = add_sub_tail_drd_alterable_memory_0(b, l + 1);
    r = r && adm_drd(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_alterable_memory(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // ADDI tail_data_size_all___imm_alterable_data
  ...
  /* ********************************************************** */
  // bit_tail_drd_drd | bit_tail_drd_alterable_memory | bit_tail_quick_drd | bit_tail_quick_alterable_memory
  static boolean bit_tail(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail")) return false;
    boolean r;
    r = bit_tail_drd_drd(b, l + 1);
    if (!r) r = bit_tail_drd_alterable_memory(b, l + 1);
    if (!r) r = bit_tail_quick_drd(b, l + 1);
    if (!r) r = bit_tail_quick_alterable_memory(b, l + 1);
    return r;
  }

  /* ********************************************************** */
  // data_size_byte? adm_drd   COMMA operand_alterable_memory
  static boolean bit_tail_drd_alterable_memory(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail_drd_alterable_memory")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bit_tail_drd_alterable_memory_0(b, l + 1);
    r = r && adm_drd(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_alterable_memory(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_byte?
  private static boolean bit_tail_drd_alterable_memory_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail_drd_alterable_memory_0")) return false;
    data_size_byte(b, l + 1);
    return true;
  }
  ...
  static boolean bit_tail_drd_drd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail_drd_drd")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bit_tail_drd_drd_0(b, l + 1);
    r = r && adm_drd(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_drd(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_long?
  private static boolean bit_tail_drd_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail_drd_drd_0")) return false;
    data_size_long(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_byte? adm_quick COMMA operand_alterable_memory
  static boolean bit_tail_quick_alterable_memory(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail_quick_alterable_memory")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bit_tail_quick_alterable_memory_0(b, l + 1);
    r = r && adm_quick(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_alterable_memory(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_byte?
  private static boolean bit_tail_quick_alterable_memory_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail_quick_alterable_memory_0")) return false;
    data_size_byte(b, l + 1);
    return true;
  }
  ...
  static boolean bit_tail_quick_drd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail_quick_drd")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bit_tail_quick_drd_0(b, l + 1);
    r = r && adm_quick(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_drd(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_long?
  private static boolean bit_tail_quick_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bit_tail_quick_drd_0")) return false;
    data_size_long(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // bool_tail_data_drd |
  //                         bool_tail_drd_alterable_memory |
  //                         bool_tail_imm_ccr |
  //                         bool_tail_imm_sr |
  //                         tail_data_size_all___imm_alterable_data
  static boolean bool_tail(PsiBuilder b, int l) {
    ...
    boolean r;
    r = bool_tail_data_drd(b, l + 1);
    if (!r) r = bool_tail_drd_alterable_memory(b, l + 1);
    if (!r) r = bool_tail_imm_ccr(b, l + 1);
    if (!r) r = bool_tail_imm_sr(b, l + 1);
    if (!r) r = tail_data_size_all___imm_alterable_data(b, l + 1);
    return r;
  ...
  /* ********************************************************** */
  // data_size_all?  operand_data COMMA adm_drd
  static boolean bool_tail_data_drd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_data_drd")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bool_tail_data_drd_0(b, l + 1);
    r = r && operand_data(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_drd(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_all?
  private static boolean bool_tail_data_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_data_drd_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // data_size_all?  adm_drd COMMA operand_alterable_memory
  static boolean bool_tail_drd_alterable_memory(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_drd_alterable_memory")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bool_tail_drd_alterable_memory_0(b, l + 1);
    r = r && adm_drd(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_alterable_memory(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_all?
  private static boolean bool_tail_drd_alterable_memory_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_drd_alterable_memory_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  static boolean bool_tail_imm_alterable_data(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_imm_alterable_data")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bool_tail_imm_alterable_data_0(b, l + 1);
    r = r && adm_imm(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_alterable_data(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_all?
  private static boolean bool_tail_imm_alterable_data_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_imm_alterable_data_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  static boolean bool_tail_imm_ccr(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_imm_ccr")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bool_tail_imm_ccr_0(b, l + 1);
    r = r && adm_imm(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_ccr(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  static boolean bool_tail_imm_sr(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_imm_sr")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = bool_tail_imm_sr_0(b, l + 1);
    r = r && adm_imm(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_sr(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_word?
  private static boolean bool_tail_imm_sr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bool_tail_imm_sr_0")) return false;
  ...
  /* ********************************************************** */
  // BSR data_size_all_single? adm_abs
  ...
  /* ********************************************************** */
  // data_size_byte? adm_drd   COMMA operand_memory
  static boolean btst_tail_drd_memory(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "btst_tail_drd_memory")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = btst_tail_drd_memory_0(b, l + 1);
    r = r && adm_drd(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_memory(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // data_size_byte? adm_quick COMMA operand_memory_without_imm
  static boolean btst_tail_quick_memory(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "btst_tail_quick_memory")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = btst_tail_quick_memory_0(b, l + 1);
    r = r && adm_quick(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_memory_without_imm(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // data_size_byte?
  private static boolean btst_tail_quick_memory_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "btst_tail_quick_memory_0")) return false;
    data_size_byte(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // CHK data_size_word_long? operand_data COMMA adm_drd
  public static boolean chk_instruction(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, operand_data(b, l + 1)) && r;
  ...
  /* ********************************************************** */
  // CLR tail_data_size_all___alterable_data
  public static boolean clr_instruction(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && tail_data_size_all___alterable_data(b, l + 1);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // data_size_all?
  private static boolean cmp_tail_api_api_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_tail_api_api_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // data_size_word_long? adm_ard COMMA adm_drd
  static boolean cmp_tail_ard_drd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_tail_ard_drd")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = cmp_tail_ard_drd_0(b, l + 1);
    r = r && adm_ard(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_drd(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_word_long?
  private static boolean cmp_tail_ard_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_tail_ard_drd_0")) return false;
    data_size_word_long(b, l + 1);
    return true;
  }
  ...
  // data_size_all?
  private static boolean cmp_tail_data_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_tail_data_drd_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  static boolean cmp_tail_imm_alterable_data(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = cmp_tail_imm_alterable_data_0(b, l + 1);
    r = r && adm_imm(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_alterable_data(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_all?
  private static boolean cmp_tail_imm_alterable_data_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_tail_imm_alterable_data_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  //                        bool_tail_imm_ccr |
  //                        bool_tail_imm_sr
  static boolean eor_tail(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // data_size_all? adm_drd COMMA operand_alterable_data
  static boolean eor_tail_drd_alterable_data(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "eor_tail_drd_alterable_data")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = eor_tail_drd_alterable_data_0(b, l + 1);
    r = r && adm_drd(b, l + 1);
    p = r; // pin = adm_drd
    r = r && report_error_(b, consumeToken(b, COMMA));
  ...
  private static boolean move_instruction_1(PsiBuilder b, int l) {
    ...
    if (!r) r = move_tail_data_ccr(b, l + 1);
  ...
  // data_size_word_long?
  private static boolean move_tail_ard_alterable_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_ard_alterable_0")) return false;
    data_size_word_long(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // data_size_word? adm_ccr COMMA operand_alterable_data
  static boolean move_tail_ccr_alterable_data(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_ccr_alterable_data")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = move_tail_ccr_alterable_data_0(b, l + 1);
    r = r && adm_ccr(b, l + 1);
    p = r; // pin = 2
    r = r && report_error_(b, consumeToken(b, COMMA));
    r = p && operand_alterable_data(b, l + 1) && r;
  ...
  // data_size_word?
  private static boolean move_tail_ccr_alterable_data_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_ccr_alterable_data_0")) return false;
    data_size_word(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_all? operand_data COMMA operand_alterable_data
  static boolean move_tail_data_alterable_data(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_data_alterable_data")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = move_tail_data_alterable_data_0(b, l + 1);
    r = r && operand_data(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && operand_alterable_data(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_all?
  private static boolean move_tail_data_alterable_data_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_data_alterable_data_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_word? operand_data COMMA adm_ccr
  static boolean move_tail_data_ccr(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_data_ccr")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = move_tail_data_ccr_0(b, l + 1);
    r = r && operand_data(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_ccr(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_word?
  private static boolean move_tail_data_ccr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_data_ccr_0")) return false;
    data_size_word(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_word? operand_data COMMA adm_sr
  static boolean move_tail_data_sr(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_data_sr")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = move_tail_data_sr_0(b, l + 1);
    r = r && operand_data(b, l + 1);
    r = r && consumeToken(b, COMMA);
    r = r && adm_sr(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // data_size_word?
  private static boolean move_tail_data_sr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_data_sr_0")) return false;
    data_size_word(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_word? adm_sr COMMA operand_alterable_data
  static boolean move_tail_sr_alterable_data(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_sr_alterable_data")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = move_tail_sr_alterable_data_0(b, l + 1);
    r = r && adm_sr(b, l + 1);
    p = r; // pin = 2
    r = r && report_error_(b, consumeToken(b, COMMA));
    r = p && operand_alterable_data(b, l + 1) && r;
  ...
  // data_size_word?
  private static boolean move_tail_sr_alterable_data_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "move_tail_sr_alterable_data_0")) return false;
    data_size_word(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // adm_rrd COMMA operand_ctrl_register
  static boolean movec_to_ctrl_tail(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, consumeToken(b, COMMA));
    r = p && operand_ctrl_register(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  //                       (
  //                         movem_tail_register_list_apd |
  //                         movem_tail_register_list_alterable_control |
  //                         movem_tail_restore_operands_register_list |
  //                         movem_tail_register_list_imm_apd |
  //                         movem_tail_register_list_imm_alterable_control |
  //                         movem_tail_restore_operands_register_list_imm
  //                       )
  ...
  private static boolean movem_instruction_2(PsiBuilder b, int l) {
    ...
    boolean r;
    r = movem_tail_register_list_apd(b, l + 1);
    if (!r) r = movem_tail_register_list_alterable_control(b, l + 1);
    if (!r) r = movem_tail_restore_operands_register_list(b, l + 1);
    if (!r) r = movem_tail_register_list_imm_apd(b, l + 1);
    if (!r) r = movem_tail_register_list_imm_alterable_control(b, l + 1);
    if (!r) r = movem_tail_restore_operands_register_list_imm(b, l + 1);
    return r;
  }
  ...
  /* ********************************************************** */
  // adm_register_list COMMA adm_apd
  static boolean movem_tail_register_list_apd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "movem_tail_register_list_apd")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = adm_register_list(b, l + 1);
    r = r && consumeToken(b, COMMA);
  ...
  /* ********************************************************** */
  // adm_imm COMMA adm_apd
  static boolean movem_tail_register_list_imm_apd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "movem_tail_register_list_imm_apd")) return false;
    if (!nextTokenIs(b, HASH)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = adm_imm(b, l + 1);
  ...
  /* ********************************************************** */
  // adm_rrd COMMA operand_alterable_memory
  static boolean moves_tail_to(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, consumeToken(b, COMMA));
    r = p && operand_alterable_memory(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // NBCD data_size_byte? operand_alterable_data
  ...
  /* ********************************************************** */
  // NEG tail_data_size_all___alterable_data
  ...
  /* ********************************************************** */
  // NEGX tail_data_size_all___alterable_data
  ...
  /* ********************************************************** */
  // NOT tail_data_size_all___alterable_data
  ...
  /* ********************************************************** */
  // data_size_byte? operand_alterable_data
  ...
  /* ********************************************************** */
  // shift_tail_alterable_memory |
  //     shift_tail_drd_drd |
  //     shift_tail_quick_drd |
  //     shift_tail_drd
  static boolean shift_tail(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "shift_tail")) return false;
    boolean r;
    r = shift_tail_alterable_memory(b, l + 1);
    if (!r) r = shift_tail_drd_drd(b, l + 1);
    if (!r) r = shift_tail_quick_drd(b, l + 1);
    if (!r) r = shift_tail_drd(b, l + 1);
    return r;
  }

  /* ********************************************************** */
  // data_size_word? operand_alterable_memory
  static boolean shift_tail_alterable_memory(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "shift_tail_alterable_memory")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = shift_tail_alterable_memory_0(b, l + 1);
    r = r && operand_alterable_memory(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // data_size_word?
  private static boolean shift_tail_alterable_memory_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "shift_tail_alterable_memory_0")) return false;
    data_size_word(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_all?  adm_drd
  ...
  /* ********************************************************** */
  // data_size_all?  adm_drd COMMA adm_drd
  static boolean shift_tail_drd_drd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "shift_tail_drd_drd")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = shift_tail_drd_drd_0(b, l + 1);
    r = r && adm_drd(b, l + 1);
    r = r && consumeToken(b, COMMA);
    p = r; // pin = COMMA
    r = r && adm_drd(b, l + 1);
  ...
  // data_size_all?
  private static boolean shift_tail_drd_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "shift_tail_drd_drd_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // data_size_all?  adm_quick COMMA adm_drd
  static boolean shift_tail_quick_drd(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "shift_tail_quick_drd")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = shift_tail_quick_drd_0(b, l + 1);
    r = r && adm_quick(b, l + 1);
    p = r; // pin = adm_quick
    r = r && report_error_(b, consumeToken(b, COMMA));
    r = p && adm_drd(b, l + 1) && r;
  ...
  // data_size_all?
  private static boolean shift_tail_quick_drd_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "shift_tail_quick_drd_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // SUBI tail_data_size_all___imm_alterable_data
  ...
  static boolean tail_data_size_all___alterable_data(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "tail_data_size_all___alterable_data")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = tail_data_size_all___alterable_data_0(b, l + 1);
    r = r && operand_alterable_data(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // data_size_all?
  private static boolean tail_data_size_all___alterable_data_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "tail_data_size_all___alterable_data_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // data_size_all? adm_imm COMMA operand_alterable_data
  static boolean tail_data_size_all___imm_alterable_data(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "tail_data_size_all___imm_alterable_data")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = tail_data_size_all___imm_alterable_data_0(b, l + 1);
    r = r && adm_imm(b, l + 1);
    p = r; // pin = 2
    r = r && report_error_(b, consumeToken(b, COMMA));
    r = p && operand_alterable_data(b, l + 1) && r;
  ...
  // data_size_all?
  private static boolean tail_data_size_all___imm_alterable_data_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "tail_data_size_all___imm_alterable_data_0")) return false;
    data_size_all(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // TAS data_size_byte? operand_alterable_data
  ...
  /* ********************************************************** */
  // TST (tst_tail_data | tail_data_size_all___alterable_data | tst_tail_ard)
  ...
  // tst_tail_data | tail_data_size_all___alterable_data | tst_tail_ard
  private static boolean tst_instruction_1(PsiBuilder b, int l) {
    ...
    if (!r) r = tail_data_size_all___alterable_data(b, l + 1);
