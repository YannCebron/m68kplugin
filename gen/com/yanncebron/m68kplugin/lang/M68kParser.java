...
public class M68kParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(AND_EXPRESSION, DIV_EXPRESSION, EXPRESSION, LABEL_REF_EXPRESSION,
      LOGICAL_AND_EXPRESSION, LOGICAL_OR_EXPRESSION, MINUS_EXPRESSION, MOD_EXPRESSION,
      MUL_EXPRESSION, NUMBER_EXPRESSION, OR_EXPRESSION, PAREN_EXPRESSION,
      PLUS_EXPRESSION, SHIFT_LEFT_EXPRESSION, SHIFT_RIGHT_EXPRESSION, STRING_EXPRESSION,
      UNARY_COMPLEMENT_EXPRESSION, UNARY_MINUS_EXPRESSION, UNARY_NOT_EXPRESSION, UNARY_PLUS_EXPRESSION,
      XOR_EXPRESSION),
