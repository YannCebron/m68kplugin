...
public class M68kParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(ABCD_INSTRUCTION, ADDA_INSTRUCTION, ADDI_INSTRUCTION, ADDQ_INSTRUCTION,
      ...
      EOR_INSTRUCTION, EXG_INSTRUCTION, EXT_INSTRUCTION, FO_DIRECTIVE,
      LEA_INSTRUCTION, LINK_INSTRUCTION, LSL_INSTRUCTION, LSR_INSTRUCTION,
      MACRO_CALL_DIRECTIVE, MOVEA_INSTRUCTION, MOVEC_INSTRUCTION, MOVEM_INSTRUCTION,
      MOVEP_INSTRUCTION, MOVEQ_INSTRUCTION, MOVES_INSTRUCTION, MOVE_INSTRUCTION,
