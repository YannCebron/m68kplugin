...
public class M68kParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(ABCD_INSTRUCTION, ADDA_INSTRUCTION, ADDI_INSTRUCTION, ADDQ_INSTRUCTION,
      ADDX_INSTRUCTION, ADD_INSTRUCTION, ADM_RRD_INDEX, ANDI_INSTRUCTION,
      AND_INSTRUCTION, ASL_INSTRUCTION, ASR_INSTRUCTION, BCC_INSTRUCTION,
      BCHG_INSTRUCTION, BCLR_INSTRUCTION, BCS_INSTRUCTION, BEQ_INSTRUCTION,
      BGE_INSTRUCTION, BGT_INSTRUCTION, BHI_INSTRUCTION, BHS_INSTRUCTION,
      BLE_INSTRUCTION, BLK_DIRECTIVE, BLO_INSTRUCTION, BLS_INSTRUCTION,
      BLT_INSTRUCTION, BMI_INSTRUCTION, BNE_INSTRUCTION, BPL_INSTRUCTION,
      BRA_INSTRUCTION, BSET_INSTRUCTION, BSR_INSTRUCTION, BTST_INSTRUCTION,
      BVC_INSTRUCTION, BVS_INSTRUCTION, CHK_INSTRUCTION, CLR_INSTRUCTION,
      CMPA_INSTRUCTION, CMPI_INSTRUCTION, CMPM_INSTRUCTION, CMP_INSTRUCTION,
      DBCC_INSTRUCTION, DBCS_INSTRUCTION, DBEQ_INSTRUCTION, DBF_INSTRUCTION,
      DBGE_INSTRUCTION, DBGT_INSTRUCTION, DBHI_INSTRUCTION, DBHS_INSTRUCTION,
      DBLE_INSTRUCTION, DBLO_INSTRUCTION, DBLS_INSTRUCTION, DBLT_INSTRUCTION,
      DBMI_INSTRUCTION, DBNE_INSTRUCTION, DBPL_INSTRUCTION, DBRA_INSTRUCTION,
      DBT_INSTRUCTION, DBVC_INSTRUCTION, DBVS_INSTRUCTION, DCB_DIRECTIVE,
      DC_DIRECTIVE, DIVS_INSTRUCTION, DIVU_INSTRUCTION, DS_DIRECTIVE,
