...
public class M68kParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(ABCD_INSTRUCTION, ADDA_INSTRUCTION, ADDI_INSTRUCTION, ADDQ_INSTRUCTION,
      ...
      AND_INSTRUCTION, ASL_INSTRUCTION, ASR_INSTRUCTION, BCHG_INSTRUCTION,
      BCLR_INSTRUCTION, BLK_DIRECTIVE, BSET_INSTRUCTION, BSR_INSTRUCTION,
      BTST_INSTRUCTION, CHK_INSTRUCTION, CLR_INSTRUCTION, CMPA_INSTRUCTION,
      CMPI_INSTRUCTION, CMPM_INSTRUCTION, CMP_INSTRUCTION, DCB_DIRECTIVE,
      DC_DIRECTIVE, DS_DIRECTIVE, EORI_INSTRUCTION, EOR_INSTRUCTION,
      ...
      MOVEQ_INSTRUCTION, MOVE_INSTRUCTION, NBCD_INSTRUCTION, NEGX_INSTRUCTION,
      ...
      ROXR_INSTRUCTION, RS_DIRECTIVE, SBCD_INSTRUCTION, SUBA_INSTRUCTION,
